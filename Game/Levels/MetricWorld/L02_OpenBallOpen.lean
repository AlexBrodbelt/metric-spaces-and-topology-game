...
Title "Proving the open ball is open"
...
Statement :
    ∀ c : X, ∀ r : ℝ, IsOpen (Metric.ball c r) := by
  intros c r
...
NewTactic apply exact use

NewTheorem Metric.isOpen_iff Metric.mem_ball add_lt_add_right dist_triangle
